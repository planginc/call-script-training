// Sales Manual Content - Real markdown content from the training files

export const salesManualContent = {
  '01-company-and-industry': `---
...
"Right now you are not likely to qualify for a healthy consolidation loan that improves your finances because of X and Y. Let's review safer options."【23†source】`,
  ...
  '02-debt-relief-options': `# Debt Relief Options

## Overview
This section covers the various debt relief options available to consumers and how to position ClearOne Advantage effectively.
...
Always present options objectively and let clients choose the path that works best for their situation.`,

  '03-ae-role-expectations': `# Account Executive Role & Expectations
...
Every interaction represents ClearOne Advantage. Build trust through:
...
- Client education`,
  ...
  '04-application-enrollment': `# Application and Enrollment Process

## Overview
Step-by-step process for enrolling clients in the debt settlement program.
...
6. Special purpose account setup

## Compliance Requirements
- Full disclosure of program terms
- Clear explanation of fees
- Client understanding verification
- Documentation requirements`,

  '05-lead-management': `# Lead Management
...
- State eligibility`,
  ...
  '06-credit-analysis': `# Credit Analysis

## Purpose
Determine client eligibility and program suitability based on credit profile.
...
5. Present findings to client`,
  ...
  '07-eligible-debts': `# Eligible Debts
...
- Maximum individual account: $50,000
- Total program debt: $10,000 - $100,000`,

  '08-program-explanation': `# Program Explanation

## Overview
Clear explanation of how the debt settlement program works.

## Key Components
1. Stop making payments to creditors
2. Make monthly program payments
3. Accumulate funds in special purpose account
4. Negotiate settlements with creditors
5. Pay settlements when reached
...
- Client responsibilities`,
  ...
  '09-budget-verification': `# Budget Verification

## Purpose
Ensure clients can afford the program payments and have sufficient income.

## Verification Process
1. Review income documentation
2. Calculate monthly expenses
3. Determine available funds
4. Verify payment capacity
5. Document findings
...
- Payment authorization`,
  ...
  '10-tools-systems': `# Tools and Systems
...
export const getSalesManualContent = (fileName: string): string => {
  return salesManualContent[fileName as keyof typeof salesManualContent] || '';
};